...
\title{Specjalista IT}
\address{Adres}{Warszawa, Klaudyny 32 m 1}
\mobile{600~858~250}
...
\section{Edukacja}
    \cventry{2007--2013}{Inżynier}{Polsko-Japońska Wyższa Szkoła Technik Komputerowych}{Warszawa}{\textit{Informatyka}}{Description}

    \cventry{2005--2007}{Wykształcenie średnie}{Liceum Ogólnokształcące im. Joachima Lelewela}{Warszawa}{}{Description}

\section{Języki obce}
    \cvitemwithcomment{Angielski}{Płynna znajomość}{Łatwość w bezpośredniej komunikacji w języku angielskim.}
...
\section{Umiejętności}
    ...
    \cvitem{Sprzęt}{Serwery oraz stacje robocze DELL, Przełączniki oraz routery CISCO i DELL, Zasilacze awaryjne APC}
    \cvitem{Platformy}{Active Directory, Group Policy, MSSQL, Mysql, Postgresql, IIS, apache, nginx, lighttpd, Cacti, Graylog2}
