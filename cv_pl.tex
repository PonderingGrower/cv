...
\section{Języki obce}
    \cvitemwithcomment{Angielski}{Biegle}{Łatwość w bezpośredniej komunikacji w języku angielskim i szerokie słownictwo techniczne.}
...
\section{Umiejętności}
    ...
    \cvitem{Platformy}{Active Directory, Group Policy, Hyper-V, VirtualBox, MSSQL, Mysql, Postgresql, IIS, apache, nginx, lighttpd, Samba, NFS, rsync, Cacti, Graylog2}
