...
\section{Edukacja}
    \cventry{2007--2013}{Inżynier}{Polsko-Japońska Wyższa Szkoła Technik Komputerowych}{Warszawa}{\textit{Informatyka}}{\footnotesize Studia inżynierskie w katerze Sieci Komputerowych na specjalizacji ``Programowanie Systemowe i Sieciowe''.}

    \vspace*{3mm}
    \cventry{2005--2007}{Wykształcenie średnie}{Liceum Ogólnokształcące im. Joachima Lelewela}{Warszawa}{}{}

\section{Doświadczenie}
\cventry{2018--Now\\\includegraphics[width=\hintscolumnwidth]{status}}{Specialista DevOps}{Status.im}{Zdalna}{Pełen etat}
    {Odpowiedzialny za całą infrastrukture. Zwłaszcza wspieranie i dostarczanie narzędzi dla deweloperów, testerów, oraz badaczy Status.im aby pozwolić im poruszać się tak szybko jak chcą.}
{\footnotesize
    \cvlistitem{Konfiguracja systemów "Ciągłej integracji"}
    \cvlistitem{Skalowalne grupy węzłów Ethereum oraz ich monitoring i alarmy }
    \cvlistitem{Edukacje deweloperów w zakresie operacji i bezpieczeństwa}
}
\vspace*{3mm}
\cventry{2015--2018\\\includegraphics[width=\hintscolumnwidth]{aws}}{System Development Engineer}{Amazon Web Services}{Dublin}{Pełen etat}
...
\vspace*{3mm}
\cventry{2014--2015\\\includegraphics[width=\hintscolumnwidth]{codility}}{System Administrator}{Codility Polska Sp. z o.o}{Warsaw}{Pełen etat}
    {Zarządzanie wewnętrznymi narzędziami deweloperskimi oraz administracja i rozwój infrastruktury głównej usługi Codility. Odpowiedzialny za:}
{\footnotesize
...
\vspace*{3mm}
\cventry{2013--2014\\\includegraphics[width=\hintscolumnwidth]{ascen}}{Administrator Systemów i Deweloper}{Ascen Sp. z o.o}{Warszawa}{Pełen etat}
    {Administracja oraz tworzenie rozwiązań transformacji danych oraz raportowania na potrzeby wielu projektów. Między innymi:}
{\footnotesize
...
\vspace*{3mm}
\cventry{2013--2014\\\includegraphics[width=\hintscolumnwidth]{raiffeisen}}{Administrator Systemów}{Raiffeisen Polbank S.A.}{Warszawa}{Pełen etat}
    {Administrowanie środowiskami migracyjnymi opartymi na systemach AIX Unix udostępniającymi usługi IBM DB2 oraz narzędzia migracyjne IBM oraz Oracle na potrzeby przeniesienia danych z systemów bazodanowych Polbank do RaiffeisenPolbank. Wykonywanie głównego procesu migracji oraz komunikacja z koordynatorami oraz grupami projektowymi. Odpowiedzialny za:}
{\footnotesize
...
\vspace*{3mm}
\cventry{2011--2013\\\includegraphics[width=\hintscolumnwidth]{trinity}}{Specjalista IT}{Trinity Corporate Services Sp. z o.o.}{Warszawa}
    {Pełen etat}{Nadzorowanie i opieka nad infrastrukturą IT oraz rozwiązywanie wszelkich problemów technicznych. Wykonywanie projektów, np.: migracji systemu pocztowego z lokalnych serwerów do zdalnego dostawcy, modernizacji infrastruktury biur zagranicznych lub wdrażanie oprogramowania. Odpowiedzialny za:}
{\footnotesize
...
\cvitem{Języki}{C, C\#, Python, Ruby, JavaScript, Java, Bash, AWK, Powershell, SQL, Lua, Solidity, \LaTeX}
\cvitem{Systemy}{GNU/Linux(Debian, Ubuntu i Getoo, Amazon Linux), Windows Server, IBM AIX Unix}
    ...
    \cvitem{Platformy}{Chef, Ansible, Fabric, Terraform, Apache, nginx, lighttpd, Gunicorn, uWSGI, Samba, NFS, Grafana, Graphite, Graylog2, Netdata, iptables, bind, postfix, Active Directory, Group Policy, Hyper-V, VMWare, VirtualBox, DB2, MSSQL, MySQL, Postgresql, IIS}
