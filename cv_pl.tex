...
\cventry{2013--Teraz\\\includegraphics[width=\hintscolumnwidth]{ascen}}{Administrator Systemów i Deweloper}{Ascen Sp. z o.o}{Warszawa}{Pełen etat}{Administracja oraz tworzenie rozwiązań transformacji danych oraz raportowania na potrzeby wielu projektów. Między innymi:}
    \cvitem{}{Tworzenie rozwiązania ETL dla Polskich Linii Lotniczych LOT}
    \cvlistitem{Rozwijanie procesu ładowanie i eksportowania danych w wielu formatach w Microsoft SSIS}
...
\section{Umiejętności}
    ...
    \cvitem{Platformy}{Active Directory, Group Policy, Hyper-V, VMWare, VirtualBox, DB2, MSSQL, MySQL, Postgresql, IIS, Apache, nginx, lighttpd, Samba, NFS, rsync, Symantec Backup Exec, Cacti, Graylog2, iptables, iproute2, bind, postfix}
